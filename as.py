...
if not mayordeEdad1:
    ...
    if puedeRepetir:
        repites1=hobbit3
sumaEdadesHobbits=edadHobbit1+edadHobbit2+edadHobbit3
print("La suma de las edades de los 3 hobbits es: " +str(sumaEdadesHobbits))
print("¿Pueden repetir?")
if sumaEdadesHobbits%2==0:
    print(f"{hobbit1} "+str(puedeRepetir))
    if puedeRepetir:
        repites=hobbit1
elif sumaEdadesHobbits%3==0:
    print(f"{hobbit2} "+str(puedeRepetir))
    if puedeRepetir:
        repites=hobbit2
elif sumaEdadesHobbits%5==0:
    print(f"{hobbit3} "+str(puedeRepetir))
    if puedeRepetir:
        repites=hobbit3
print("repiten " +str(repites1) + " y "  +str(repites))
